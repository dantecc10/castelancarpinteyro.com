...
<script>
  ...
  gtag('config', 'G-HV59T08TYC');
    ...
    <title>Inicio - Castelán Carpinteyro</title>
    <meta name="theme-color" content="#5436cd">
    <link rel="canonical" href="https://castelancarpinteyro.com/Exportaciones/">
    <meta property="og:url" content="https://castelancarpinteyro.com/Exportaciones/">
    ...
    <link rel="icon" type="image/png" sizes="4398x3333" href="../assets/img/castelancarpinteyro/DanteDEV.png?h=2f30b138ca17bcf6a7233a69b31b94c4">
    <link rel="icon" type="image/png" sizes="4398x3333" href="../assets/img/castelancarpinteyro/DanteDEV.png?h=2f30b138ca17bcf6a7233a69b31b94c4">
    <link rel="icon" type="image/png" sizes="4405x3333" href="../assets/img/castelancarpinteyro/DanteDEV-Black-Blackground.png?h=e8b1a8ee8ae3c16570c7f4e2d36fbb57">
    <link rel="icon" type="image/png" sizes="4398x3333" href="../assets/img/castelancarpinteyro/DanteDEV.png?h=2f30b138ca17bcf6a7233a69b31b94c4">
    <link rel="icon" type="image/png" sizes="4405x3333" href="../assets/img/castelancarpinteyro/DanteDEV-Black-Blackground.png?h=e8b1a8ee8ae3c16570c7f4e2d36fbb57">
    <link rel="stylesheet" href="../assets/bootstrap/css/bootstrap.min.css?h=ae25e30cd2ef0f4f5b70ebf4c668048b">
    <link rel="manifest" href="../manifest.json?h=0d1dd6f571bf7ac7ba535eed3081a32a" crossorigin="use-credentials">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&amp;display=swap">
    <link rel="stylesheet" href="../assets/css/Accordion.css?h=b78dde6c542e958695ec9c6ac716ad09">
    <link rel="stylesheet" href="../assets/css/Carousel-Hero.css?h=7cde5a36eb6eecd3422146f7b3a30f43">
    <link rel="stylesheet" href="../assets/css/extra.css?h=3937a51c191f6f2216b9cec7fa19806c">
    <link rel="stylesheet" href="../assets/css/uiverse.css?h=31f977f72db975d12e0ad3a54ee106b8">
</head>
...
<body style="/*background: url(&quot;design.jpg&quot;);*/background-position: 0 -60px;">
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="https://castelancarpinteyro.com"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon rueda-logo"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-code-slash">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/aprende.php">Aprende</a></li>
    ...
    <section class="py-5">
        ...
        <div class="carousel slide" data-bs-ride="carousel" id="carousel-3">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="bg-light border rounded border-light hero-nature carousel-hero jumbotron py-5 px-4">
                        ...
                        <p class="hero-subtitle">Dale dinamismo y funciones avanzadas a tu página con los recursos y lecciones que tenemos de JavaScript.</p>
            ...
            <div class="carousel-indicators"><button type="button" data-bs-target="#carousel-3" data-bs-slide-to="0" class="active"></button> <button type="button" data-bs-target="#carousel-3" data-bs-slide-to="1"></button> <button type="button" data-bs-target="#carousel-3" data-bs-slide-to="2"></button></div>
                    ...
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <p class="text-muted card-text mb-4">Diseña, crea, y administra bases de datos para conectarlas a tu sitio.</p><a href="#"><button class="btn btn-primary shadow" type="button">Consultar</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <p class="text-muted card-text mb-4">Crea el DOM de tus páginas web con etiquetas de HTML5 de forma profesional.</p><a href="#"><button class="btn btn-primary shadow" type="button">Consultar</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <p class="text-muted card-text mb-4">Aquí habrá guías para la administración de servidores; basado en Plesk Obsidian en Ubuntu.</p><a href="#"><button class="btn btn-primary shadow" type="button">Consultar</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <p class="text-muted card-text mb-4">Integra envíos automáticos y manuales de correos electrónicos en tus páginas y en tu servidor. Configura el webmail.</p><a href="#"><button class="btn btn-primary shadow" type="button">Consultar</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col mb-4">
                        <div class="card bg-primary-light">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3">Prepárate para hacer de tu web un sitio dinámico y con funcionalidades del lado del cliente</h5><a href="#"><button class="btn btn-primary shadow" type="button">Consultar</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card bg-secondary-light">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3">Crea el maquetado de tu web; aprende sobre metadatos, sé experto en SEO, y construye la base de una página</h5><a href="#"><button class="btn btn-primary shadow" type="button">Consultar</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card bg-info-light">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3">Dale estilo a tu DOM con hojas de estilo en cascada, usa frameworks como Bootstrap, y deja volar tu creatividad</h5><a href="#"><button class="btn btn-primary shadow" type="button">Consultar</button></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#"><strong>Diseño web</strong><br></a></li>
                        <li><a href="#">Hosting</a></li>
                        <li><a href="#"><strong>Desarrollo backend-frontend</strong><br></a></li>
                    </ul>
                </div><!-- End: About -->
                <!-- Start: Services -->
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#">Castelán Carpinteyro</a></li>
...
<svg class="bi bi-github" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
    ...
    <script src="../assets/js/bs-init.js?h=d9bd2573841747de24c24fe71b2f72e3"></script>
    <script src="../assets/js/bold-and-dark.js?h=914b066f52f5e2b2583e4d1558c90518"></script>
    <script src="../assets/js/course-navigation.js?h=144da972c3ef4cad0d62837f307258e6"></script>
</body>
