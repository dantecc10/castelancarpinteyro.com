...
<script>
  ...
  gtag('config', 'G-HV59T08TYC');
    ...
    <link rel="canonical" href="https://castelancarpinteyro.com/Exportaciones/Software.html">
    <meta property="og:url" content="https://castelancarpinteyro.com/Exportaciones/Software.html">
            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2">Carpeta de programas</p>
                        <h1 class="fw-bold">Software</h1>
                        <p class="text-muted w-lg-50"><strong><span style="color: rgb(255, 255, 255);">Descargas disponibles</span></strong><br></p>
                    </div>
                </div>
            </div>
            <div class="row pt-5">
                <div class="col">
                    ...
                    <p class="sangría" style="text-align: justify;"><a href="https://cecytepuebla-my.sharepoint.com/personal/d_castelanc_chg_2023_cecytepuebla_edu_mx/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fd%5Fcastelanc%5Fchg%5F2023%5Fcecytepuebla%5Fedu%5Fmx%2FDocuments%2FPROGRAMAS%20PC%27S%20AVANZADOS%2004%2D03%2D2022&amp;ga=1" target="_blank">Da click aquí</a> para ir a la carpeta de software.</p>
